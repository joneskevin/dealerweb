...
<script language='javascript'>
	...
	<body>
			...
			<tr align="center">
				<td height=25 colspan=2 bgcolor="#39867B">
					<div align="left" class="style4">
						<strong>当前位置：</strong>内容管理 &gt; 论坛管理 &gt;新闻发布
					</div>
			</tr>
			<tr>
				<td width="81%" height=23 nowrap class="bgcolor">
					<strong>管理菜单：</strong>
					<a
						href="<%=request.getContextPath()%>/back/backForum/orgForumPostMan/orgForumPostManAction.do?action=displayEditPost"
						target="_self">发新闻帖</a>
				</td>
			...
			<html:form
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="6" align="center" class="40td">
						<html:submit property="action.searchPost" value="搜  索"
							styleClass="bgcolor" />
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr class="bgcolor">
				<td width="3%" nowrap>
				<div align="center"><a style="cursor:hand" id="selectAll"
					onClick="selectAll('checkedThreadIds')">全选</a></div>
				</td>
			...
			<html:form
				...
				<logic:notEmpty name="PROJ_FORUM_POST_MAN_FORM" property="orgForumThreadsForList">
					<logic:iterate id="thread" name="PROJ_FORUM_POST_MAN_FORM"
						...
						<tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#DFEDEA'" onMouseOut="this.bgColor='#FFFFFF'">
							<td nowrap align="center"><input type="checkbox" name="checkedThreadIds" value="<bean:write name='thread'
							...
							<td nowrap>
								<bean:write name="thread" property="creationTime" format="yyyy-MM-dd"/>
							</td>
							<td nowrap>
								<a
									href="<%=request.getContextPath()%>/back/backForum/orgForumPostMan/orgForumPostManAction.do?action=displayEditPost&threadId=<bean:write
									name="thread" property="id"/>&<%=GlobalConstant.PAGE_NO%>=<%=myPageNo%>">修改 </a>
								<a
									href="<%=request.getContextPath()%>/back/backForum/orgForumPostMan/orgForumPostManAction.do?action=deletePost&threadId=<bean:write
					...
					<td colspan=10 align=right>
						<div align="right">
							<jsp:include page="/pub/navigate/navigation.jsp" flush="true">
								...
								<jsp:param name="pageFormAct" value="searchPost" />
							</jsp:include>
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
					<td colspan="4" align="right" class="40td">
						<html:select name="PROJ_FORUM_POST_MAN_FORM" property="customizedPostSortId">
							<html:optionsCollection name="PROJ_FORUM_POST_MAN_FORM" property="customizedPostSortList"
							 label="optionText" value="optionValue" />
						</html:select>
						<html:submit property="action.publishPost" value="发  布"
							styleClass="bgcolor" />
					</td>
					<td align="right" class="40td" width="6">
					</td>
					<td colspan="5" align="left" class="40td">
						<html:submit property="action.transferPost" value="迁移到"
							styleClass="bgcolor" />
						<html:select name="PROJ_FORUM_POST_MAN_FORM" property="forumSortId">
							<option value="-1">请选择</option>
							<html:optionsCollection name="PROJ_FORUM_POST_MAN_FORM" property="forumSortList"
							 label="nodeName" value="id" />
						</html:select>
					</td>
				</tr>
			</html:form>
