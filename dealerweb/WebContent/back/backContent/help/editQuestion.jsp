...
<table width="100%" border="0" cellpadding="2" cellspacing="1"
	...
	<tr>
		...
		<div align="right"><a href="javascript:history.back();"><img
			...
			src="<%=request.getContextPath()%>/back/images/refresh.gif" border="0"></a></div>
		</td>
	</tr>
</table>
<form id="myPageForm" action="/back/question/edit.vti" method="post">
<form:hidden path="question.id" />
<table width="100%" height="132" border="0" align="center"
	cellpadding="2" cellspacing="1" class="tablebg">
    	<tr>
        	<th colspan="2" height="30" class="bgcolor" style=" font:normal 13px;" align="center">编辑BASE帮助</th>
        </tr>
		<tr>
		...
		<tr bgcolor="#FFFFFF">
			...
			<td class="40td">
				<input name="" type="submit" class="bgcolor" value="编 辑">
