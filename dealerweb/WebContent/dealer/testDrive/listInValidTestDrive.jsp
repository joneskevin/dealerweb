...
function gotoLoadExcel(){
	pageFormObj.action="<%=path%>/dealer/testDrive/exportInValidTestDrive.vti?startIndex=${transMsg.startIndex}";
    pageFormObj.submit();
	pageFormObj.action="<%=path%>/dealer/testDrive/listInValidTestDrive.vti";
}

</script>
<body>
<form id="myPageForm" action="<%=path%>/dealer/testDrive/listInValidTestDrive.vti" method="get" >
...
<div class="bd_rt" id="audit">
	...
	<aside class="bd_rt_main clearfix">
		<div class="table_list table_all" style="min-width:1200px;overflow-y:hidden;overflow:auto">
			<ul class="table_hd clearfix" style="width:2005px;">
			...
			<c:if test="${testDriveList != null}" >
				<c:forEach var="vo" items="${testDriveList}" varStatus="statusObj">
					<ul class='table_bd clearfix ${statusObj.index%2==0?"even":"odd"}' style="width:2005px;">
