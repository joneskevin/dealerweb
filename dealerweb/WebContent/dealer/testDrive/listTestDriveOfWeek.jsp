...
<script>
	...
	function gotoLoadExcel(){
	   pageFormObj.action="<%=path%>/dealer/testDrive/outputWeek.vti?startIndex=${transMsg.startIndex}";
	   pageFormObj.submit();
	   pageFormObj.action="<%=path%>/dealer/testDrive/listWeek.vti";
	}     
</script>

<body>
<form id="myPageForm" action="<%=path%>/dealer/testDrive/listWeek.vti" method="get" >
<div class="bd_rt" id="audit">
	...
	<div class="audit_nav_c">
		...
		试驾周期(本年)
		第<form:input path="testDrive.week" maxlength="3"
					...
					<ul class='table_bd clearfix ${statusObj.index%2==0?"even":"odd"}' style="width:1360px;">
	            		...
	            		<li class="plateNumber_75"><span title="${vo.plateNumber}">${vo.plateNumber}</span></li>
		           		...
		           		<li class="short_operator_150">
							...
							&vehicleId=${vo.vehicleId}&lineId=${vo.lineId}&week=${testDrive.week}&higherPage=${transMsg.startIndex}">查看明细</a>
		           		</li>
					</ul>
				</c:forEach>
			</c:if>
