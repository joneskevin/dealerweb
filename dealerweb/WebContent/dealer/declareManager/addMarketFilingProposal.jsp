...
<table>
    ...
    <tr>
        ...
        <td width="200px" colspan="2">
        	<input type="text" id="filingProposal_startTime" name="startTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true})" value="<fmt:formatDate value="${filingProposal.startTime}" type="both" pattern="yyyy-MM-dd" />" class="Wdate right" readonly="true"/>
		</td>
        <td width="100px" align="right"><span>*</span>结束日期：</td>
        <td width="200px" colspan="2">
        	<input type="text" id="filingProposal_endTime" name="endTime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',autoPickDate:true})" value="<fmt:formatDate value="${filingProposal.endTime}" type="both" pattern="yyyy-MM-dd" />" class="Wdate right" readonly="true"/>
        </td>
    </tr>
    <tr>
