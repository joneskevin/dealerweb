...
<form id="myPageForm" action="<%=path%>/dealer/filingProposalManager/addFilingProposalNew.vti" method="post" enctype="multipart/form-data">
...
<table>
	...
	<input type="button" id="btnSave" onclick="save()" value="提交"  class="input_button"/>
</form>
</div>
</body>
</html>