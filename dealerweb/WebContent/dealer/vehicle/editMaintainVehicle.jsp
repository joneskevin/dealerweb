...
<body>
    <form id="myPageForm" method="post" action="<%=request.getContextPath()%>/dealer/vehicle/edit.vti">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tableBox">
            ...
            <tr>
                ...
                <td class="tdSpace" colspan="3"><span id="companyName" />
                </td>
            </tr>
            <tr>
                <td class="tdTitle">分销中心：</td>
                <td class="tdSpace" colspan="3"><span id="saleCenterName" />
                </td>
            </tr>
            <tr>
                <td class="tdTitle">省份：</td>
                <td class="tdSpace"><span id="provinceName" />
                </td>
                <td class="tdTitle">城市：</td>
                <td class="tdSpace"><span id="cityName" />
                </td>
            </tr>
            <tr>
                <td class="tdTitle">网络形态：</td>
                <td class="tdSpace" colspan="3"><span id="dealerTypeNick" />
                </td>
            </tr>
            <tr>
