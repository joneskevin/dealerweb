...
/*
 * company为主的VO   	新装申请/拆除申请 查询报表 用到
 */
public class CompanyProposalVO {
	...
	public void nick() {
		...
		status_nick =  SelectOptionResource.getOptionTextByValue(SelectOptionResource.approvalStatus, getStatus());
		
		type_nick =  SelectOptionResource.getOptionTextByValue(SelectOptionResource.proposalReportTypeArray,getType());
