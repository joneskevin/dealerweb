...
<table>
    ...
    <tr>
        ...
        <td width="35%"><fmt:formatDate value="${filingProposalCV.filingProposal.approvalTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss" /></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3" >
        	<textarea id="filingProposal_reason" name="filingProposal.reason" cols ="100" rows = "2" readonly="true" class="textarea_noborder" style="margin-bottom:5px;">${filingProposalCV.filingProposal.reason}</textarea>
        </td>
    </tr>
    <tr>
    	<td width="15%" align="right" valign="top">审核意见：</td>
        <td colspan="3">
        	<textarea id="adviceDescription" name="adviceDescription" cols ="100"  readonly="true" rows = "3" class="textarea_noborder" >${filingProposalCV.filingProposal.approvalMessage}</textarea>
        </td>
    </tr>
</table>
</div>
...
<%-- 				<span>结束时间：<fmt:formatDate value="${filingProposal.endTime}" type="both" pattern="yyyy-MM-dd HH:mm:ss"/></span> <br /> --%>
<%-- 				                    报备目的： <c:out value="${filingProposal.reason}" /> --%>
<!-- 			</p> -->
<%-- 		</c:forEach> --%>
<%-- 		</c:if> --%>
<!-- 	</aside> -->
