...
<body>
    <form id="myPageForm" method="post" action="<%=request.getContextPath()%>/dealer/proposal/add.vti" enctype="multipart/form-data">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class="tableBox">
            ...
            <tr>
                ...
                <td class="tdSpace" colspan="3">
                    <form:select id="carStyleId" path='proposalCompanyVehcileInfo.vehicle.carStyleId'>
