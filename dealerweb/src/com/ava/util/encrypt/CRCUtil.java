...
public class CRCUtil {
	private static final int crc_ccitt_table[] = { 0x0000, 0x1021, 0x2042,
	...
	/** 返回2字节的crc校验结果，用short存放 */
	public static short CRC_CCITT_16(byte[] data) {
		short da = 0;
		int crchl = 0;
		int c_index = 0;
		...
		for (byte b : data) {
			...
			crchl ^= crc_ccitt_table[(short) (c_index)];
			crchl = crchl & 0xFFFF;
		}
		return (short) crchl;
	}
